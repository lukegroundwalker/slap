// Set the date we're counting down to
	...
	// var countDownDate = new Date("Nov 17, 2017 18:53:30").getTime();
	...
	var x = setInterval(function() {
	    ...
	    if (distance < 1000) {
	        ...
	        responsiveVoice.speak("That's all folks","UK English Male",{pitch: 0.5});
	        clearInterval(x);
	    	...
	    	// if(seconds%2==0)
	        	// responsiveVoice.speak("tik");
	     //    else
	        	// responsiveVoice.speak("tock");
	    }
	}, 1000);